...
export default function Rodin() {
  ...
  const ExternalLinks = () => (
    <div className="flex items-center space-x-6">
      <a
        href="https://prince-kachhwaha-myportfolio.vercel.app/"
        target="_blank"
      ...
      <a
        href="https://github.com/Prince8085"
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center text-white hover:text-gray-300 transition-colors tracking-normal"
      >
        <span className="mr-1">Git-hub</span>
        <ExternalLink className="h-4 w-4" />
      </a>
    </div>
  )
    ...
    <div className="relative h-[100dvh] w-full">
      ...
      <div className="absolute inset-0 z-10 pointer-events-none">
        ...
        <div className="absolute top-6 left-6 pointer-events-auto">
          ...
          <p className="text-gray-400 text-sm mt-1 tracking-normal">Created by  Prince Kachhwaha ❤️❤️</p>
        </div>
